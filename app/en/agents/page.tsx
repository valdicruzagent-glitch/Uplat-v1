    ...
    <div className="min-h-dvh bg-zinc-50 text-zinc-900 dark:bg-black dark:text-zinc-50">
      <header className="sticky top-0 z-[1001] border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/80">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
          <Link href="/en" className="text-lg font-bold tracking-tight">Uplat</Link>
          <div className="flex items-center gap-4">
            <Link href="/agents" className="text-sm font-medium text-blue-600">Agents</Link>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        {loading ? (
          <p className="text-zinc-600">Loading agents...</p>
        ) : filtered.length === 0 ? (
          <p className="text-zinc-600">No agents found.</p>
        ) : (
